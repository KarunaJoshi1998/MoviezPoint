...
import com.example.moviezpoint.Models.ComingPreviewDataModel;
import com.example.moviezpoint.Models.Config;
import com.example.moviezpoint.Models.GetCastModel;
import com.example.moviezpoint.Models.MovieDetailsModel;
import com.example.moviezpoint.Models.PreviewDataModel;
...
public class ComingSoonPreviewActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coming_soon_preview);
        ...
        HorizontalLayout = new LinearLayoutManager(ComingSoonPreviewActivity.this,LinearLayoutManager.HORIZONTAL,false);
        ...
        HorizontalLayoutYoutube = new LinearLayoutManager(ComingSoonPreviewActivity.this,LinearLayoutManager.HORIZONTAL,false);
        ...
        youtubeVideoDataModelCall.enqueue(new Callback<YoutubeVideoDataModel>() {
            ...
            public void onResponse(Call<YoutubeVideoDataModel> call, Response<YoutubeVideoDataModel> response) {
                if (response.isSuccessful()) {
                    ...
                    startYoutubeData();
                    YoutubeRecyclerAdapter youtubeRecyclerAdapter= new YoutubeRecyclerAdapter(ComingSoonPreviewActivity.this,youtubeVideoDataModel,posterPath);
                    ...
                    recyclerViewYoutube.addOnItemTouchListener(new RecyclerView.OnItemTouchListener() {
                        GestureDetector detector = new GestureDetector(ComingSoonPreviewActivity.this, new GestureDetector.SimpleOnGestureListener() {
                            @Override
                    ...
                    Toast.makeText(ComingSoonPreviewActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<YoutubeVideoDataModel> call, Throwable t) {
                Toast.makeText(ComingSoonPreviewActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void startYoutubeData() {
        youTubeView.initialize(Config.YOUTUBE_API_KEY,ComingSoonPreviewActivity.this);
    }
    ...
    public void getMovieProductionData(MovieDetailsModel movieDetailsModel) {
        RecyclerViewHorizontalAdapter = new RecyclerViewAdapter(movieDetailsModel,ComingSoonPreviewActivity.this);
        recyclerView.setAdapter(RecyclerViewHorizontalAdapter);
        scrollView.setVisibility(View.VISIBLE);
        loader.setVisibility(View.GONE);
    }
